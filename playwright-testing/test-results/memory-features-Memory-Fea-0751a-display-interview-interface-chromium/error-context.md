...
- Name: Memory Features >> should display interview interface
- Location: /home/tim/WebsitePrototype/playwright-testing/tests/memory-features.spec.js:75:3
...
Received: false
    at /home/tim/WebsitePrototype/playwright-testing/tests/memory-features.spec.js:94:48
```
...
- text: Only share what you're comfortable sharing. You can skip any question by saying 'next question'. All memories are private by default.
- button "I Understand - Start Interview"
- navigation:
  - link "← Dashboard":
    - /url: ../dashboard.html
  - heading "Memory Interview with Winston" [level=1]
  - button "Save & Exit"
  - button "Interviews"
  - button "New Interview"
- text: 🧠 Neo4j Knowledge Graph Component Placeholder Graph controls and visualization will be injected here
- button "≡ Interview Manager"
- button "|| Stop Session"
- text: ↑ Click to expand chat 🎩 Hello! I'm Winston, your story curator. I'm here to help you capture and organize your precious memories. What would you like to talk about today?
- textbox "Share a memory or ask a question..."
- button "🎤"
- button "+ New Interview"
