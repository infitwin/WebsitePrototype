...
- Name: Memory Features >> should display memory capture interface
- Location: /home/tim/WebsitePrototype/playwright-testing/tests/memory-features.spec.js:4:3
...
Locator: locator('input[type="file"], button:has-text("Upload"), .upload-button').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('input[type="file"], button:has-text("Upload"), .upload-button').first()

    at /home/tim/WebsitePrototype/playwright-testing/tests/memory-features.spec.js:22:30
```
...
```yaml
- main:
  - heading "Let's Capture Your First Memory" [level=1]
  - paragraph: Every great journey begins with a single story
  - text: ✨
  - heading "What's one piece of wisdom you'd want to pass on?" [level=2]
  - paragraph: Think of advice you'd give to your younger self or future generations
  - 'textbox "For example: ''Take more risks when you''re young. The biggest regrets come from chances not taken...''"'
  - text: "0 / 500 💡 Tip: Be authentic, speak from your heart"
  - button "🎤 Record Instead"
  - button "📅 Add When/Where"
  - button "📷 Add Photo"
  - button "Try Another Prompt"
  - button "Continue Building →" [disabled]
  - text: 🌟 2,847 memories captured today
```
