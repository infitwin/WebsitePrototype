...
Locator: locator('[data-page="files"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 60000ms
  - waiting for locator('[data-page="files"]')
    ...
    at /home/tim/WebsitePrototype/playwright-testing/tests/navigation-no-explore.spec.js:39:29
```
